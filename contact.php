            ...
            <div class="col-md-8 col-sm-6 home-feature">
              <h1>CONTACT US</h1>
               <form method="post" action="contact_scripts.php">
                   ...
                   <div class="form-group">
                       <textarea type="text" rows="4" class="form-control" name="address" placeholder="Ask anything about the website?" required="true"></textarea>
                   </div>
              ...
              <div class="col-md-4 col-sm-6 home-feature">
                 ...
                 <p>Roorkee, India-247667</p><br>
                 <p>Phone: +91 8171899493</p><br>
                 <p>Email: prakhartamta@gmail.com</p>
                 <p>Email: amithal.lko@gmail.com</p><br><br>    
              </div>
          </div>
       </div>
    </body>
