...
only developer or person who is controls the website in backend can see after going to (http://localhost/syntaxerror/fordeveloper.php)-->
<?php
...
<div class="container">
   <?php while($row=mysqli_fetch_array($select_query_result)) {?>
    ...
    <div class="col-xs-11"><?php echo $row['query'] ?></div>
    </div>
